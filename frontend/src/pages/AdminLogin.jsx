...
export default function AdminLogin() {
  ...
  const onSubmit = async (formData) => {
    ...
    try {
      ...
      // Axios received a response from your backend
      if (error.response) {
      ...
      // Request was sent but no response came back
        ...
        console.error(
          'Possible network/CORS/server problem'
        )
  ...
  const inputClass =
    "w-full bg-gray-800 border border-green-800/30 rounded-lg px-4 py-3 text-gray-100 text-sm placeholder:text-gray-500 focus:outline-none focus:border-green-600/60 transition-colors"
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center px-6">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <div className="font-accent text-xs tracking-[0.4em] text-green-500 uppercase mb-2">
            Ministry Admin
          </div>
        ...
        <div className="glass-card rounded-2xl p-8 border border-green-800/20">
          ...
          <div
            className="w-14 h-14 rounded-full border border-green-600/30 flex items-center justify-center mx-auto mb-6"
            style={{
              background:
          ...
          >
            ...
            <div>
              ...
              <label className="block text-xs text-gray-400 font-accent tracking-wider uppercase mb-2">
                Email
              </label>
